package com.rohitjakhar.compose.ratingdialog
...
import com.rohitjakhar.compose.ratingdialog.buttons.ConfirmButtonClickListener
import com.rohitjakhar.compose.ratingdialog.buttons.CustomFeedbackButtonClickListener
import com.rohitjakhar.compose.ratingdialog.buttons.RateButton
import com.rohitjakhar.compose.ratingdialog.buttons.RateDialogClickListener
import com.rohitjakhar.compose.ratingdialog.dialog.DialogOptions
import com.rohitjakhar.compose.ratingdialog.dialog.RateDialogCompose
import com.rohitjakhar.compose.ratingdialog.dialog.RateDialogFragment
import com.rohitjakhar.compose.ratingdialog.logging.RatingLogger
import com.rohitjakhar.compose.ratingdialog.preferences.ConditionsChecker
        ...
        internal fun showGoogleInAppReview() {
            ...
            requestTask.addOnCompleteListener { request ->
                if (request.isSuccessful) {
                    ...
                    val flow = reviewManager?.launchReviewFlow(componentActivity as Activity, reviewInfo) ?: run {
                        onGoogleInAppReviewFailure(componentActivity.getString(R.string.rating_dialog_log_in_app_review_initial_request_is_null))
                        return@addOnCompleteListener
                    }
